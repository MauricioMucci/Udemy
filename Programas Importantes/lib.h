...
void pause()
{
	printf("If you would like to continue hit any key.");
	getchar();
}
...
void archive(Company *pointer)
{
    ...
    FILE *file;
    char name_of_the_file[20];

    printf("What's the name of the file you would like to access?\n");
        fgets(name_of_the_file,20,stdin);

    if ((file = fopen(strtok(name_of_the_file,"\n"),"w")) == NULL)
    {
