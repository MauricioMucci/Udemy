...
int main(){
	...
	for(int i = 0; i < 10; i++)
    {
        ...
        /*	
		Se k for igual a m (tamanho do vetor com_repeticao) quer dizer que o numero do vetor[i] é um número não repetido, 
    	logo ele será armazenado no vetor sem_repeticao,(para se ter um numero que nao repita nenhuma vez o k tem q ser 
		do mesmo tamanho do vetor com_repeticao)
        */
		if(k == m)
        {
